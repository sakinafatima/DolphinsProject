...
df = pd.read_csv(file, names=["filename", "framenumber", "x0", "y0", "x1", "y1",
                              "label","velocity1","velocity2", "filepath" ,"comment1", "comment2", "comment3",
...
trainSet.to_csv("TrainingData/train.csv", index=False, header=False, encoding='utf_8_sig')
validSet.to_csv("TrainingData/valid.csv", index=False, header=False,encoding='utf_8_sig')
testSet.to_csv("TrainingData/test.csv", index=False, header=False, encoding='utf_8_sig')
